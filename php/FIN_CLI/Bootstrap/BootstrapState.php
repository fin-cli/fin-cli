 ...
 * & framework/commands you use outside of Phar (like when running the Phar FIN inside of a command folder).
 * @phpcs:disable FinPress.NamingConventions.ValidFunctionName.MethodNameInvalid
 */
class BootstrapState {
