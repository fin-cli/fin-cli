...
final class ContextManager {
	...
	/**
	 * Register a context with FIN-CLI.
	 *
	...
	/**
	 * Switch the context in which to run FIN-CLI.
	 *
	...
	public function switch_context( $config ) {
		...
		if ( ! array_key_exists( $context, $this->contexts ) ) {
			FIN_CLI::error( "Unknown context '{$context}'" );
		}

		FIN_CLI::debug( "Using context '{$context}'", Context::DEBUG_GROUP );
