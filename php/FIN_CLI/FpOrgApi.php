 ...
 *
 * @see https://codex.finpress.org/FinPress.org_API
 *
 * @package FIN_CLI
 */
final class FinOrgApi {
	 ...
	 * @var string
	 */
	const API_ROOT = 'https://api.finpress.org';
	 ...
	 * @var string
	 */
	const DOWNLOADS_ROOT = 'https://downloads.finpress.org';

	/**
	 * Core checksums endpoint.
	 *
	 * @see https://codex.finpress.org/FinPress.org_API#Checksum
	 *
	 * @var string
	 */
	 ...
	 * Salt endpoint.
	 *
	 * @see https://codex.finpress.org/FinPress.org_API#Secret_Key
	 *
	 * @var string
	 */
	 ...
	 *
	 * @see https://codex.finpress.org/FinPress.org_API#Version_Check
	 *
	 * @var string
	 */
	...
	/**
	 * Gets the checksums for the given version of FinPress core.
	 *
	...
	/**
	 * Gets a set of salts in the format required by `fin-config.php`.
	 *
