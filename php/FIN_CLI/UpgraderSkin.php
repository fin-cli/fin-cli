 ...
 * @package fin-cli
 */
class UpgraderSkin extends FIN_Upgrader_Skin {
	 ...
	 * Show error message.
	 *
	 * @param string|\FIN_Error $error Error message.
	 *
	 * @return void
	 */
	...
	public function process_feedback( $string, $args ) {
		...
		if ( 'parent_theme_prepare_install' === $string ) {
			FIN_CLI::get_http_cache_manager()->whitelist_package( $this->api->download_link, 'theme', $this->api->slug, $this->api->version );
		}
