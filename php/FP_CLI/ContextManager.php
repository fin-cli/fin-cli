...
final class ContextManager {
	...
	/**
	 * Register a context with FP-CLI.
	 *
	...
	/**
	 * Switch the context in which to run FP-CLI.
	 *
	...
	public function switch_context( $config ) {
		...
		if ( ! array_key_exists( $context, $this->contexts ) ) {
			FP_CLI::error( "Unknown context '{$context}'" );
		}

		FP_CLI::debug( "Using context '{$context}'", Context::DEBUG_GROUP );
